...
import { Activity, Calculator, Home, Settings, ShieldAlert, Users, Wifi, WifiOff } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-background">
      {/* Sidebar */}
      <aside className="w-full md:w-60 border-r border-border bg-card flex flex-col flex-shrink-0">
        {/* Wordmark */}
