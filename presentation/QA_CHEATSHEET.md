...
A: SENTRY Tier-1 classifier is ~100K parameters. PULSE equipment-failure predictor is ~8K. ThermalHawk-Nano v2 is 1.77M. All three add to ~1.88M total ML parameters for the full SPIRE stack. Each trained with cyclic-restart SGDR, cross-validated across six published domains in the HawkStack technical report.
