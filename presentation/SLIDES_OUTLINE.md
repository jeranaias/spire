...
Every HawkStack model trained with cyclic-restart SGDR. Same protocol validated across six published domains (SentryHawk, ForgeHawk, DepthHawk, CellHawk, WildHawk, ECG). No pretraining. No cloud.
