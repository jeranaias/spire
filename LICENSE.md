...
| **ThermalHawk-Nano v2** | ~1.73M parameter thermal drone detection model (Thornveil proprietary architecture architecture, SGDR-trained) with trained weights | Thornveil proprietary; provisional patent pending |
