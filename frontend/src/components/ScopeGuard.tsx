  ...
  return (
    <div className="flex h-full items-center justify-center p-8">
      ...
      >
        ...
        <div className="mb-3 font-mono text-[15px] font-semibold text-[var(--color-text)]" style={{ letterSpacing: "0.04em" }}>
          {view.toUpperCase().replace("/", "")} is not in your authorization scope.
        </div>
        <div className="mb-4 font-mono text-[11px] text-[var(--color-text-secondary)]" style={{ letterSpacing: "0.04em" }}>
        ...
        <div className="mb-4 font-mono text-[10px] text-[var(--color-text-muted)]" style={{ letterSpacing: "0.12em" }}>
        ...
        <button
          onClick={() => nav(home)}
          className="rounded-sm border border-[var(--color-primary)] bg-[var(--color-primary)] px-3 py-1.5 font-mono text-[11px] font-semibold uppercase text-white hover:bg-[var(--color-primary-hover)]"
