...
//
// `DatasetBadge` and friends were extracted to `components/DatasetBadge.tsx`
// in Task #127 so BASTION and the PULSE surfaces can stamp the same "AS OF
// DDMMMYY" pill in their own tile/section headers — a judge drilling from
// the bridge into a downstream surface no longer loses the freshness cue.
// ---------------------------------------------------------------------------
